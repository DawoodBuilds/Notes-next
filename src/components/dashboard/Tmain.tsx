    ...
    <div className="h-screen flex flex-col items-center bg-slate-50 w-screen">
      ...
      {step === "input" && (
        <div className="min-h-screen bg-white w-full flex flex-col">
          ...
          <div className="fixed bottom-6 right-6 md:bottom-6 md:right-10 flex flex-col items-end gap-2 z-50 max-sm:bottom-10 max-sm:right-8">
            ...
            <Button
              className="rounded-full px-6 py-6 md:px-8 md:py-6 text-base md:text-lg shadow-2xl cursor-pointer bg-black lg:hover:scale-105 transition-all duration-300 ease-in-out"
